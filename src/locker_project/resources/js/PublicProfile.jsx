...
export default function PublicProfile() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0B0F19] font-sans pb-12 relative overflow-x-hidden transition-colors duration-500">
                ...
                <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/40 dark:bg-black/60 backdrop-blur-md p-4">
                    <div className="bg-white/80 dark:bg-[#0B0F19]/80 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.1)] border border-white/40 dark:border-white/5 w-full max-w-lg overflow-hidden animate-fade-in-up max-h-[90vh] flex flex-col relative">
                        <div className="flex justify-between items-center p-5 border-b border-gray-200/50 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-800/30">
                            ...
                            <button onClick={() => setIsContactModalOpen(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors bg-white/50 dark:bg-slate-800 hover:bg-white dark:hover:bg-slate-700 p-1.5 rounded-full shadow-sm focus:outline-none">
                        ...
                        <div className="overflow-y-auto p-6 md:p-8 flex-1">
                            <div className="space-y-4">
                                ...
                                <a href={getWaUrl(userData.wa_number)} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-4 group cursor-pointer ${!userData.wa_number ? 'opacity-50 pointer-events-none' : ''}`}>
                                    <div className={`p-3 rounded-2xl transition-all shadow-sm border ${userData.wa_number ? 'bg-green-50/80 dark:bg-green-900/20 text-green-600 border-green-200 dark:border-green-800 group-hover:bg-green-100 dark:group-hover:bg-green-900/40 group-hover:scale-105' : 'bg-gray-50 dark:bg-slate-800 text-gray-400 border-gray-200 dark:border-slate-700 group-hover:scale-105'}`}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12.031 0C5.385 0 0 5.385 0 12.031c0 2.115.548 4.187 1.591 6.008l-1.57 5.733 5.86-1.538a11.953 11.953 0 006.15 1.696h.004c6.645 0 12.03-5.385 12.03-12.03S18.676 0 12.031 0z" /></svg></div>
                                    <div className="flex-1">
                                        <p className={`text-sm font-semibold transition ${userData.wa_number ? 'text-gray-900 dark:text-white group-hover:text-green-700 dark:group-hover:text-green-500' : 'text-gray-500 dark:text-gray-400'}`}>WhatsApp</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{userData.wa_number ? `+${userData.wa_number}` : 'Belum diatur'}</p>
                                    </div>
                                </a>
                                ...
                                <a href={getInstaUrl(userData.insta_username)} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-4 group cursor-pointer ${!userData.insta_username ? 'opacity-50 pointer-events-none' : ''}`}>
                                    <div className={`p-3 rounded-2xl transition-all shadow-sm border ${userData.insta_username ? 'bg-purple-50/80 dark:bg-purple-900/20 text-purple-600 border-purple-200 dark:border-purple-800 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/40 group-hover:scale-105' : 'bg-gray-50 dark:bg-slate-800 text-gray-400 border-gray-200 dark:border-slate-700 group-hover:scale-105'}`}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.919-.058-1.265-.069-1.646-.069-4.849 0-3.204.013-3.583.069-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.668-.072-4.948-.197-4.347-2.633-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4.162 4.162 0 110-8.324A4.162 4.162 0 0112 16zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" /></svg></div>
                                    <div className="flex-1">
                                        <p className={`text-sm font-semibold transition ${userData.insta_username ? 'text-gray-900 dark:text-white group-hover:text-purple-700 dark:group-hover:text-purple-500' : 'text-gray-500 dark:text-gray-400'}`}>Instagram</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate max-w-[180px]">{userData.insta_username ? `@${userData.insta_username}` : 'Belum diatur'}</p>
                                    </div>
                                </a>
                                ...
                                <a href={getFbUrl(userData.facebook_url)} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-4 group cursor-pointer ${!userData.facebook_url ? 'opacity-50 pointer-events-none' : ''}`}>
                                    <div className={`p-3 rounded-2xl transition-all shadow-sm border ${userData.facebook_url ? 'bg-blue-50/80 dark:bg-blue-900/20 text-blue-600 border-blue-200 dark:border-blue-800 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40 group-hover:scale-105' : 'bg-gray-50 dark:bg-slate-800 text-gray-400 border-gray-200 dark:border-slate-700 group-hover:scale-105'}`}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.128 22 16.991 22 12z" /></svg></div>
                                    <div className="flex-1">
                                        <p className={`text-sm font-semibold transition ${userData.facebook_url ? 'text-gray-900 dark:text-white group-hover:text-blue-700 dark:group-hover:text-blue-500' : 'text-gray-500 dark:text-gray-400'}`}>Facebook</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate max-w-[180px]">{userData.facebook_url ? 'Sudah Terhubung' : 'Belum diatur'}</p>
                                    </div>
                                </a>
                                ...
                                <a href={getGithubUrl(userData.github_username)} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-4 group cursor-pointer ${!userData.github_username ? 'opacity-50 pointer-events-none' : ''}`}>
                                    <div className={`p-3 rounded-2xl transition-all shadow-sm border ${userData.github_username ? 'bg-gray-100/80 dark:bg-gray-800/80 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-700 group-hover:bg-gray-200 dark:group-hover:bg-gray-700 group-hover:scale-105' : 'bg-gray-50 dark:bg-slate-800 text-gray-400 border-gray-200 dark:border-slate-700 group-hover:scale-105'}`}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg></div>
                                    <div className="flex-1">
                                        <p className={`text-sm font-semibold transition ${userData.github_username ? 'text-gray-900 dark:text-white group-hover:text-gray-800 dark:group-hover:text-gray-300' : 'text-gray-500 dark:text-gray-400'}`}>GitHub Open Source</p>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate max-w-[180px]">{userData.github_username ? `@${userData.github_username}` : 'Belum diatur'}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
            ...
            {/* --- MODAL POP-UP CV --- */}
            {isCvModalOpen && userData.cv_url && createPortal(
                <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 sm:p-8">
                    <div className="bg-white dark:bg-[#0B0F19] rounded-2xl w-full max-w-5xl h-full flex flex-col overflow-hidden shadow-2xl animate-fade-in-up">
                        <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-900">
                            <h3 className="font-bold text-gray-900 dark:text-white">CV / Resume - {userData.name}</h3>
                            <div className="flex gap-2">
                                <a href={userData.cv_url} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-[#8100D1] text-white rounded-lg text-sm font-semibold hover:bg-purple-800 transition">Buka di Tab Baru</a>
                                <button onClick={() => setIsCvModalOpen(false)} className="p-2 text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white bg-gray-200 dark:bg-slate-800 hover:bg-gray-300 dark:hover:bg-slate-700 rounded-lg transition">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" /></svg>
                                </button>
                            </div>
                        </div>
                        <div className="flex-1 w-full bg-gray-100 dark:bg-black relative">
                            <iframe src={`${userData.cv_url}#toolbar=0`} className="absolute inset-0 w-full h-full border-none" title="CV Full View" />
                        </div>
                    </div>
                </div>,
                document.body
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-8 space-y-6">
                {/* BIO CARD */}
                <div className="bg-white/90 dark:bg-[#0B0F19]/90 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgba(129,0,209,0.08)] dark:shadow-[0_0_20px_rgba(129,0,209,0.15)] border border-purple-100/60 dark:border-purple-800/40 overflow-hidden relative animate-fade-in-up group">
                ...
                {/* PENGALAMAN CARD */}
                <div className="bg-white/90 dark:bg-[#0B0F19]/90 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgba(129,0,209,0.08)] dark:shadow-[0_0_20px_rgba(129,0,209,0.15)] border border-purple-100/60 dark:border-purple-800/40 overflow-hidden mb-6 relative animate-fade-in-up group" style={{ animationDelay: '0.2s' }}>
                    <div className="absolute inset-0 pointer-events-none rounded-3xl border border-transparent group-hover:border-purple-500/10 transition-colors duration-500 z-50"></div>
                ...
                {/* PENDIDIKAN CARD */}
                <div className="bg-white/90 dark:bg-[#0B0F19]/90 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgba(129,0,209,0.08)] dark:shadow-[0_0_20px_rgba(129,0,209,0.15)] border border-purple-100/60 dark:border-purple-800/40 overflow-hidden mb-6 relative animate-fade-in-up group" style={{ animationDelay: '0.3s' }}>
                    <div className="absolute inset-0 pointer-events-none rounded-3xl border border-transparent group-hover:border-purple-500/10 transition-colors duration-500 z-50"></div>
                    <div className="p-6 border-b border-gray-100 dark:border-slate-800">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white/90 dark:bg-[#0B0F19]/90 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgba(129,0,209,0.08)] dark:shadow-[0_0_20px_rgba(129,0,209,0.15)] border border-purple-100/60 dark:border-purple-800/40 overflow-hidden h-full relative animate-fade-in-up group" style={{ animationDelay: '0.4s' }}>
                        <div className="absolute inset-0 pointer-events-none rounded-3xl border border-transparent group-hover:border-purple-500/10 transition-colors duration-500 z-50"></div>
                        <div className="p-6 border-b border-gray-100 dark:border-slate-800">
                    ...
                    {/* CV / RESUME CARD */}
                    <div className="bg-white/90 dark:bg-[#0B0F19]/90 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgba(129,0,209,0.08)] dark:shadow-[0_0_20px_rgba(129,0,209,0.15)] border border-purple-100/60 dark:border-purple-800/40 overflow-hidden h-full relative animate-fade-in-up group" style={{ animationDelay: '0.5s' }}>
                        <div className="absolute inset-0 pointer-events-none rounded-3xl border border-transparent group-hover:border-purple-500/10 transition-colors duration-500 z-50"></div>
                        <div className="p-6 border-b border-gray-100 dark:border-slate-800">
                            ...
                            {userData.cv_url ? (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-bold text-gray-900 dark:text-white group-hover/cv:text-[#8100D1] transition-colors">Resume/CV</p>
                                            <p className="text-xs text-gray-500 dark:text-gray-400">Klik untuk melihat detail dokumen</p>
                                        </div>
                                    </div>
                                    <div className="text-gray-400 group-hover/cv:text-[#8100D1] transition-colors">
