        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 py-10 px-4">
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 w-full max-w-md text-center">
                    ...
                    <Link to="/forgot-password" className="text-[#8100D1] font-semibold hover:underline">Minta Tautan Baru</Link>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-10 px-4">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 w-full max-w-md">
                ...
                <div className="text-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Atur Ulang Password</h2>
                    <p className="text-gray-500 text-sm mt-2">Masukkan password baru untuk akun <strong>{email}</strong></p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                minLength="8"
                                className="w-full pl-4 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8100D1] focus:border-[#8100D1] outline-none transition-all"
                        ...
                        <button
                            ...
                            className={`w-full text-white font-semibold py-3 px-4 rounded-lg transition-colors mt-4 shadow-sm ${isLoading || !password || !passwordConfirmation ? 'bg-[#cba8e9] cursor-not-allowed' : 'bg-[#8100D1] hover:bg-[#6b00ac]'}`}
                        >
