    ...
    return (
        <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm z-10 h-full">
            ...
            <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <Link to="/dashboard" className={`flex items-center px-4 py-3 mt-2 rounded-xl transition-colors font-medium text-sm ${isActive('/dashboard') ? 'bg-purple-50 text-[#8100D1]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}>
                ...
                <Link to="/companies" className={`flex items-center px-4 py-3 mt-2 rounded-xl transition-colors font-medium text-sm ${isActive('/companies') ? 'bg-purple-50 text-[#8100D1]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}>
                ...
                <Link to="/jobs" className={`flex items-center px-4 py-3 mt-2 rounded-xl transition-colors font-medium text-sm ${isActive('/jobs') ? 'bg-purple-50 text-[#8100D1]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}>
                ...
                <Link to="/analytics" className={`flex items-center px-4 py-3 mt-2 rounded-xl transition-colors font-medium text-sm ${isActive('/analytics') ? 'bg-purple-50 text-[#8100D1]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}>
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                    {t('admin.sidebar.analytics')}
                </Link>

                <Link to="/settings" className={`flex items-center px-4 py-3 mt-2 rounded-xl transition-colors font-medium text-sm ${isActive('/settings') ? 'bg-purple-50 text-[#8100D1]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}>
