        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <p className="text-sm font-semibold text-gray-500 mb-1">{t('admin.dashboard.total_users')}</p>
                    ...
                    <div className="text-sm">
                        <span className="text-green-500 font-medium">+12%</span> <span className="text-gray-400">{t('admin.dashboard.from_last_month')}</span>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <p className="text-sm font-semibold text-gray-500 mb-1">{t('admin.dashboard.pending_verification')}</p>
                    ...
                    <div className="text-sm">
                        <Link to="/users" className="text-[#8100D1] font-medium hover:underline flex items-center gap-1">{t('admin.dashboard.review_companies')} <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg></Link>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <p className="text-sm font-semibold text-gray-500 mb-1">{t('admin.dashboard.pending_jobs')}</p>
                    ...
                    <div className="text-sm">
                        <Link to="/jobs" className="text-[#8100D1] font-medium hover:underline flex items-center gap-1">{t('admin.dashboard.review_jobs')} <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg></Link>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                    <h3 className="text-lg font-bold text-gray-800 mb-4">{t('admin.dashboard.recent_activity')}</h3>
                ...
                <div className="bg-gradient-to-br from-[#8100D1] to-purple-800 rounded-xl shadow-md p-6 text-white relative overflow-hidden">
                    <div className="relative z-10">
                        <h3 className="text-lg font-bold mb-2">{t('admin.dashboard.system_status_title')}</h3>
                        <p className="text-purple-100 text-sm mb-6 leading-relaxed">
                            {t('admin.dashboard.system_status_desc')}
                        </p>
                        ...
                        <div className="relative bg-white rounded-xl shadow-lg">
                            <div className="flex items-center justify-between p-4 md:p-5 border-b border-gray-100 rounded-t">
                                ...
                                <button onClick={() => setIsModalOpen(false)} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center">
                                    ...
                                    <span className="sr-only">{t('admin.dashboard.close_modal_sr')}</span>
                                </button>
                            </div>
                            <div className="p-4 md:p-5 space-y-4">
                                <div className="p-4 bg-green-50 rounded-lg border border-green-100 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-green-800">{t('admin.dashboard.system_running')}</h4>
                                        <p className="text-sm text-green-700 mt-1">{t('admin.dashboard.system_running_desc')}</p>
                                    </div>
                                </div>
                                
                                <div className="grid grid-cols-2 gap-4 mt-4">
                                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                                        <p className="text-xs text-gray-500 font-medium">{t('admin.dashboard.uptime')}</p>
                                        <p className="text-xl font-bold text-gray-800">99.98%</p>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                                        <p className="text-xs text-gray-500 font-medium">{t('admin.dashboard.avg_response')}</p>
                                        <p className="text-xl font-bold text-gray-800">42ms</p>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                                        <p className="text-xs text-gray-500 font-medium">{t('admin.dashboard.server_load')}</p>
                                        <p className="text-xl font-bold text-gray-800">24%</p>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                                        <p className="text-xs text-gray-500 font-medium">{t('admin.dashboard.last_check')}</p>
                                        <p className="text-xl font-bold text-gray-800">{t('admin.dashboard.last_check_value')}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-center p-4 md:p-5 border-t border-gray-100 rounded-b">
                                <button onClick={() => setIsModalOpen(false)} type="button" className="text-white bg-[#8100D1] hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-colors">{t('admin.dashboard.close_report')}</button>
                            </div>
                        </div>
                    </div>
                </div>
